...
import Vansh from '../../img/images/AboutUs/Vansh.jpg'
import Ved from '../../img/images/AboutUs/Ved.jpg'
import Parth from '../../img/images/AboutUs/Parth.jpg'
import Chirag from '../../img/images/AboutUs/Chirag.jpg'
      ...
      <section className="our-mission">
        <div className="container">
          ...
          <div className="mission-content-wrapper">
            ...
            <p>
              At Estate Heaven, we aim to revolutionize how you buy, sell, or rent property. Our focus is to make the process seamless with a trusted platform that bridges buyers and sellers effortlessly.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="our-team">
        <div className="container">
          ...
          <div className="team-members">
            ...
            <div className="team-member">
              <img src={Parth} alt="Marketing" />
              <h3>Parth Patel</h3>
              <p>Head of Marketing</p>
            </div>
            <div className="team-member">
              <img src={Chirag} alt="Project Manager" />
              <h3>Chirag Senma</h3>
              <p>Project Manager</p>
            </div>
          </div>
